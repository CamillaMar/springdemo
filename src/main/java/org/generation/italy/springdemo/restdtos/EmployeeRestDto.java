...
public class EmployeeRestDto {
    ...
    public EmployeeRestDto(int empId, String lastName, String firstName, String title, String titleOfCourtesy,
                           ...
                           String region, String postalCode, String country, String phone, int managerId) {
        this.empId = empId;
    ...
    public Employee toEmployee(){
        return new Employee(null, phone, country, postalCode, region, city,
                address, hireDate, birthDate, titleOfCourtesy, title, firstName, lastName, empId);
    }
    ...
    public static EmployeeRestDto toDto(Employee e) {
        return new EmployeeRestDto(e.getEmpId(), e.getLastName(), e.getFirstName(), e.getTitle(), e.getTitleOfCourtesy(),
                e.getBirthDate(), e.getHireDate(), e.getAddress(), e.getCity(),
                e.getRegion(), e.getPostalCode(), e.getCountry(), e.getPhone(), e.getManager().getEmpId());
    }
