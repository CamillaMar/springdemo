...
public class EmployeeRestDto {
    ...
    public EmployeeRestDto(int empId, String lastName, String firstName, String title, String titleOfCourtesy,
                           LocalDateTime birthDate, LocalDateTime hireDate, String address,
                           String city, String region, String postalCode, String country, String phone, int managerId) {
        this.empId = empId;
    ...
    public Employee toEmployee(){
        return new Employee(empId, lastName, firstName, title, titleOfCourtesy, birthDate, hireDate, address, city, region,postalCode,
                            country,phone, null);
    }
